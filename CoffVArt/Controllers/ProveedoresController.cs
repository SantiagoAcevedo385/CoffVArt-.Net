...
namespace CoffVArt.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(Coffvart2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Proveedores != null ? 
                          ...
                          Problem("Entity set 'Coffvart2Context.Proveedores'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProveedores,Nit,Nombre,Direccion,Telefono")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProveedores,Nit,Nombre,Direccion,Telefono")] Proveedore proveedore)
        {
            if (id != proveedore.IdProveedores)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ProveedoreExists(proveedore.IdProveedores))
                    {
                        return NotFound();
                    }
                    else
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Coffvart2Context.Proveedores'  is null.");
            }
            var proveedore = await _context.Proveedores.FindAsync(id);
            if (proveedore != null)
            {
